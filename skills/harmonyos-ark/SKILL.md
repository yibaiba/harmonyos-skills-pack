...
- ArkTS 命名规范、类型禁令、装饰器边界、异步错误处理、分层依赖 -> topics/arkts-engineering-rules.md
...
- ArkTS 提交前静态检查清单: checklists/arkts-static-checklist.md
- ArkTS 静态检查命令模板: checklists/arkts-static-check-commands.md
...
- ArkTS 工程硬规范: topics/arkts-engineering-rules.md
