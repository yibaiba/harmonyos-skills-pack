...
> 版本范围：6.0.0(API 20)；6.0.2 变更见 [harmonyos-6-api-core-602.md](./harmonyos-6-api-core-602.md)

<!-- Agent 摘要：本文件为 Ability Kit 6.0.0 变更明细表（~1200 行）。
     6.0.2 变更已拆分到 harmonyos-6-api-core-602.md。
     ArkTS/ArkData 变更 → harmonyos-6-api-core-arkts.md。
     概览 → harmonyos-6-overview.md。
...
> 📎 6.0.2 Ability Kit 变更见 [harmonyos-6-api-core-602.md](./harmonyos-6-api-core-602.md)
> 📎 ArkTS / ArkData API 变更见 [harmonyos-6-api-core-arkts.md](./harmonyos-6-api-core-arkts.md)

## See Also

- [harmonyos-6-api-core-602.md](./harmonyos-6-api-core-602.md) — Ability Kit 6.0.2 变更
