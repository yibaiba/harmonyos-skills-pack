...
## See Also
- **HarmonyOS 平台专项**：[harmonyos-ark/SKILL.md](../harmonyos-ark/SKILL.md) — ArkTS 编译合规、系统权限、提审材料、鸿蒙 API
- **深色模式与多端适配**：[checklists/multi-platform-dark-mode.md](checklists/multi-platform-dark-mode.md)
- **发布前通用检查**：[checklists/pre-release-universal.md](checklists/pre-release-universal.md)
- **团队评审打分**：[templates/team-review-scorecard.md](templates/team-review-scorecard.md)
